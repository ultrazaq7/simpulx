...
-- +goose Down
DROP INDEX IF EXISTS contacts_assigned_agent_idx;
ALTER TABLE contacts DROP COLUMN IF EXISTS assigned_agent_id;
ALTER TABLE contacts DROP COLUMN IF EXISTS interest_level;
ALTER TABLE contacts DROP COLUMN IF EXISTS stage_id;

...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  Widget _buildKpiRow(ThemeData theme) {
    ...
    return Row(
      children: [
        ...
        Expanded(
            child: _kpiCard(theme, 'Total Contacts', '$totalContacts',
                Icons.people_rounded, const Color(0xFF10B981), '')),
        const SizedBox(width: 16),
        Expanded(
            child: _kpiCard(
                theme,
  ...
  Widget _kpiCard(ThemeData theme, String label, String value, IconData icon,
            ...
            children: [
              ...
              if (trend.isNotEmpty)
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: const Color(0xFF42B72A).withValues(alpha: 0.08),
      ...
      child: Column(
        ...
        children: [
          ...
          if (channelDist.isEmpty)
            ...
            ...channelDist.map((ch) {
              final channel =
                  (ch['channel'] ?? 'unknown').toString().toLowerCase();
                ...
                ...agents.asMap().entries.map((e) {
                  ...
                  return TableRow(
                    children: [
                      ...
                      Padding(
                          padding: const EdgeInsets.symmetric(vertical: 12),
                          child: Text(a['name']?.toString() ?? 'Unknown',
                              style: const TextStyle(
                                  fontWeight: FontWeight.w600))),
                      Padding(
                          padding: const EdgeInsets.symmetric(vertical: 12),
                          child: Text('${a['conversations'] ?? 0}')),
                    ],
                  );
                }),
              ],

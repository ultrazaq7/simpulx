...
class NotificationService with WidgetsBindingObserver {
  ...
  static Future<void> _showLocalNotification(RemoteMessage message) async {
    ...
    final notifId = conversationId.isNotEmpty ? conversationId.hashCode : message.hashCode;
    final cacheKey = conversationId.isNotEmpty ? conversationId : notifId.toString();
    ...
    final displayBody = stacked.length > 1
        ? stacked.join('\n')
        : body;

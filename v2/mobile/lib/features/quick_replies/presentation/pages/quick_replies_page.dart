...
class _QuickRepliesPageState extends State<QuickRepliesPage> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                FilledButton.icon(
                  icon: Icon(
                      existing != null ? Icons.save_rounded : Icons.add_rounded,
                      size: 18),
                  ...
                  onPressed: () async {
                    ...
                    if (existing != null) {
                      success = await cubit.updateReply(existing.id, {
                        ...
                        'shortcut': shortcutCtrl.text.isEmpty
                            ? null
                            : shortcutCtrl.text,
  ...
  Widget _buildRepliesBody(
      BuildContext context, List<QuickReplyEntity> replies) {
    final theme = Theme.of(context);
    final isDesktop = kIsWeb || MediaQuery.of(context).size.width >= 768;
    ...
    if (!isDesktop) {
      return ListView.builder(
        ...
        itemBuilder: (context, index) =>
            _buildReplyCard(context, theme, replies[index]),
      );
    }
  ...
  Widget _buildReplyCard(
      BuildContext context, ThemeData theme, QuickReplyEntity qr) {
    return Container(
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (v) {
                  ...
                  if (v == 'delete') {
                    context.read<QuickRepliesCubit>().deleteReply(qr.id);
                  }
                },
                itemBuilder: (_) => [

...
class AppColors {
  ...
  static const Color darkBackground = Color(0xFF091613); // chat wallpaper / scaffold canvas
  static const Color darkSurface = Color(0xFF152420); // app bar / bottom sheet / cards
  static const Color darkSurfaceAlt = Color(0xFF172622); // search bar / chips / incoming bubble
  static const Color darkBorder = Color(0xFF1A2A26); // hairline separators
  ...
  static const Color bubbleIncomingDark = Color(0xFF172622);

...
class AppColors {
  ...
  static const Color darkBackground = Color(0xFF121212); // chat wallpaper / scaffold canvas
  static const Color darkSurface = Color(0xFF1A1A1A); // app bar / bottom sheet / cards

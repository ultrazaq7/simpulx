  ...
  factory ConversationModel.fromJson(Map<String, dynamic> json) {
    ...
    return ConversationModel(
      ...
      contact: json['contact'] != null
          ...
          : (json['contact_name'] != null || json['contact_phone'] != null)
              ? ContactModel(
                  id: json['contact_id'] ?? '',
                  name: json['contact_name'] ?? json['contact_phone'],
                  phone: json['contact_phone'],
                )
              : null,
      assignedAgent: json['assignedAgent'] != null
          ? AgentModel.fromJson(json['assignedAgent'])
          : (json['agent_name'] != null)
              ? AgentModel(
                  id: json['assigned_agent_id'] ?? json['assignedAgentId'] ?? '',
                  fullName: json['agent_name'],
                )
              : null,
    );
  }

...
func main() {
	...
	mux.HandleFunc("POST /api/stages", s.requireAuth(s.gate("manage_campaigns", s.handleCreateStage)))
	mux.HandleFunc("POST /api/stages/reorder", s.requireAuth(s.gate("manage_campaigns", s.handleReorderStages)))
	mux.HandleFunc("PATCH /api/stages/{id}", s.requireAuth(s.gate("manage_campaigns", s.handleUpdateStage)))
	mux.HandleFunc("DELETE /api/stages/{id}", s.requireAuth(s.gate("manage_campaigns", s.handleDeleteStage)))

...
import { MagniferLinear as Search, CheckReadLinear as Check, AltArrowDownLinear as ChevronDown, CloseCircleLinear as X, UsersGroupTwoRoundedLinear as Users } from "solar-icon-set";

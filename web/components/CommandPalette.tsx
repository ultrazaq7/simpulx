...
import {
  Search, LayoutDashboard, MessageCircle, Users, Megaphone, Settings, CornerDownLeft, ArrowUp, ArrowDown, MessageSquareText,
} from "lucide-react";
...
export default function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const NAV: CmdItem[] = useMemo(() => [
    ...
    { id: "nav-inbox", group: "Go to", label: "Inbox", icon: MessageSquareText, run: () => router.push("/inbox") },

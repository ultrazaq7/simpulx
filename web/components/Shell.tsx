...
const PAGE_TITLES: Record<string, { category: string; title: string; icon?: any }> = {
  ...
  "/inbox": { category: "INBOX", title: "Chat", icon: MessageSquareText },
  ...
  "/settings/custom-fields": { category: "CUSTOMIZATIONS", title: "Custom Fields", icon: FormInput },
  ...
  "/settings/revenue": { category: "PLATFORM", title: "Revenue", icon: Boxes },
  "/settings/transactions": { category: "PLATFORM", title: "Transactions", icon: Boxes },

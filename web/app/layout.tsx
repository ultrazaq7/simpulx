  ...
  return (
    <html lang="en" className={cn(inter.variable, "font-sans")}>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: "try{var t={'/dashboard':'Dashboard','/inbox':'My Inbox','/contacts':'Contacts','/campaigns':'Campaigns','/broadcasts':'Broadcasts','/templates':'Message Templates','/automation':'Automation','/channels':'Channels','/integrations':'Web API','/account':'Account Settings','/settings/general':'General','/settings/custom-fields':'Custom Fields','/settings/people':'Team Members','/settings/roles':'Roles & Permissions','/settings/campaigns':'Campaigns','/settings/templates':'Message Templates','/settings/automation':'Automation','/settings/wa-forms':'WhatsApp Forms','/settings/channels':'Channel & Integrations','/settings/platform':'Platform','/settings/audit':'System Logs','/settings/notifications':'Notifications','/settings':'Settings'};var p=location.pathname,best='',ti='';for(var k in t){if(p.indexOf(k)===0&&k.length>best.length){best=k;ti=t[k];}}document.title=(ti?ti+' - ':'')+'Simpulx';}catch(e){}" }} />

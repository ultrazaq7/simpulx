...
const SECTIONS: { href: string; perm: string }[] = [
  ...
  { href: "/settings/templates", perm: "manage_templates" },
  { href: "/settings/wa-forms", perm: "view_automation" },
  { href: "/settings/quick-replies", perm: "manage_quick_replies" },
  { href: "/settings/custom-fields", perm: "manage_custom_fields" },
  { href: "/settings/stages", perm: "manage_pipeline_stages" },
